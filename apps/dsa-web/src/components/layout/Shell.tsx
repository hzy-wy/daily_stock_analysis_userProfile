...
export const Shell: React.FC<ShellProps> = ({ children }) => {
  return (
    <div className="app-shell min-h-[100dvh] bg-background text-foreground">
      <PointerSpotlight />
      ...
      <div className="app-shell__frame mx-auto min-h-[100dvh] w-full max-w-[1920px] px-2.5 pb-24 pt-2.5 sm:px-4 sm:pt-4 xl:pb-5 xl:px-5">
        <CommandNavigation />
