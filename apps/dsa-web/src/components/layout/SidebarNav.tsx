...
import { Activity, BarChart3, Bell, BriefcaseBusiness, Gauge, Home, LogOut, Search, Settings2 } from 'lucide-react';
...
export const SidebarNav: React.FC<SidebarNavProps> = ({ collapsed = false, onNavigate, variant = 'default' }) => {
  ...
  const itemActiveClass = 'app-nav-item--active border-[var(--nav-active-border)] bg-[var(--nav-active-bg)] font-medium text-[hsl(var(--primary))]';
